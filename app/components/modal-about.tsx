...
export default () => {
    return(
        <Modal>
            ...
            <p>This project is an exercise of NextJS, Tailwind, and ChatGPT. AI will never have the entropy of AREA MAN, but this app is just to entertain, not throw shade.</p>
        </Modal>
    );
}